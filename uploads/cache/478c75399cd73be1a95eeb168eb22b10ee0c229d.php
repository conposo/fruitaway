            ...
            <div id="content" class="site-content" role="main">
                ...
                <div class="container">
                    <div class="row pt-5 _pb-5">
                        <?php $the_query = Home::the_query(get_queried_object()->term_id); $posts_ids = ''; ?>
                ...
                <?php echo do_shortcode('[ajax_load_more category="'.get_queried_object()->term_id.'" post_format="standard" exclude="'.$posts_ids.'" id="23141325425" container_type="div" max_pages="1" posts_per_page="4" images_loaded="true" button_label="Load more articles"]'); ?>
