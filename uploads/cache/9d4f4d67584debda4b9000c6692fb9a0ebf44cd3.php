<footer class="content-info">
  <div class="container">
    ...
    <div class="row border-bottom pt-3 pb-3">
        <div class="col">
            <img src="<?= App\asset_path('images/logo-home.svg'); ?>">
        </div>
        <div class="col">
            <?php
    ...
    <div class="row bottom-line pt-3 pb-3">
        <div class="col d-flex justify-content-between">
            <p>Copyright © <?php echo e(date("Y")); ?> <a href="<?php echo e(site_url()); ?>"><?php echo e(get_bloginfo('name', 'display')); ?></a>   |   <a href="#">Политика за конфиденциалност и безопастност на данните</a>   |   <a href="#">Връзка с ОРС</a></p>
