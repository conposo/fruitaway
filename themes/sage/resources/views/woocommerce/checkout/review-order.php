...
?>
<div class="border p-3 shop_table woocommerce-checkout-review-order-table">
			...
			<?php if ( wc_coupons_enabled() ) { ?>
				<div class="coupon under-proceed d-flex">
					<label for="" class="d-block">
						...
						<button type="submit" style="padding: 4px; background: #FE3E49; border: none;" class="py-1 text-dark button apply_coupon text-white" name="apply_coupon" value="<?php esc_attr_e( 'Apply coupon', 'woocommerce' ); ?>" >
