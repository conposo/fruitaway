...
?>
<div class="border-bottom cart_totals <?php echo ( WC()->customer->has_calculated_shipping() ) ? 'calculated_shipping' : ''; ?>">
	...
	<div class="shop_table shop_table_responsive">
		...
		<div class="border-bottom cart-subtotal">
		...
		<div class="border-bottom order-total">
